...
def test_wrapper_index_is_lexically_validated(token: str):
...
def test_public_sympy_json_round_trip(value: sympy.Basic):
    assert mod._decode(mod._json(value), ("x",)) == value


@pytest.mark.regression
def test_project_owned_code_has_no_direct_sympy_parse_calls():
