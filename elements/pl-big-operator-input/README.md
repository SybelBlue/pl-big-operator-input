...
- [`questions/qa`](../../questions/qa)

## See also

- [PrairieLearn's `pl-symbolic-input` documentation](https://prairielearn.readthedocs.io/en/latest/elements/#pl-symbolic-input-element)
