...
| `correct-answer`                                                                                                      | unset        | Preferred whole-answer string in a supported parseable form.                                                                                     |
| `correct-answer-start`, `correct-answer-end`, `correct-answer-domain`, `correct-answer-target`, `correct-answer-body` | unset        | Alternative string answers for the visible component fields. Supply every component for the resolved limits form.                                |
